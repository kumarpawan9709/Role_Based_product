...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        <div class=" container ">
        <div class=”panel-heading”>You are Sales User</div>
                        ...
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href="{{route($model.'.create')}}" class="btn btn-primary"> {{ trans("Add New ") }}</a>
                                        ...
                                        <div>
                                            ...
                                            <div class="row mt-8">
                                                <div class="col-lg-12">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <a href='{{ route("sales.home")}}' class="btn btn-secondary btn-secondary--icon">
                                                        <span>
                                            ...
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="{{(($sortBy == 'phone' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'phone' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route('sales.home',array(	'sortBy' => 'phone',
                                                    ...
                                                    <th class="{{(($sortBy == 'email' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'email' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                        <a href="{{route('sales.home',array(	'sortBy' => 'email',
